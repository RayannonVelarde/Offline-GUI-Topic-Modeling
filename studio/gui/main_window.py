...
class MainWindow(QMainWindow):
    ...
    def _build_review_page(self) -> QFrame:
        ...
        self.review_open_folder_btn.setObjectName("review-input-folder-btn")
        ...
        self.review_open_folder_btn.setFixedSize(36, 36)
        self.review_open_folder_btn.setToolTip("Open containing folder")
        self.review_open_folder_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        ...
        self.review_analyze_topics_btn = QToolButton()
        self.review_analyze_topics_btn.setObjectName("review-analyze-topics-btn")
        self.review_analyze_topics_btn.setAttribute(Qt.WidgetAttribute.WA_LayoutUsesWidgetRect, True)
        self.review_analyze_topics_btn.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        self.review_analyze_topics_btn.setIcon(
            make_nav_icon("topics", size=18, color_hex=_review_folder_muted)
        )
        self.review_analyze_topics_btn.setIconSize(QSize(18, 18))
        self.review_analyze_topics_btn.setFixedSize(36, 36)
        self.review_analyze_topics_btn.setToolTip("Analyze with Topic Modeling")
        self.review_analyze_topics_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        self.review_analyze_topics_btn.setFocusPolicy(Qt.FocusPolicy.NoFocus)
